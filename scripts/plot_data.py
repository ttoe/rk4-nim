...
### # lotka-volterra
### lv_data = pd.read_csv("lv_data.csv", sep="\t", header=0, index_col=False, comment="#")
### 
...
### 
### # rma
### rma_data = pd.read_csv("rma_data.csv", sep="\t", header=0, index_col=False, comment="#")
### 
...
bif_chemostat_data = pd.read_csv("bif_chemostat.csv", sep="\t", header=0, index_col=False, comment="#")
